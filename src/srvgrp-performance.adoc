...
This section provides an overview of the properties associated with the Fast
Channel for Performance service group.
...
* If Fast Channel support is available, retrieve Fast Channel attributes for
  specific Performance service call using the `GET_PERF_DOMAIN_FAST_CHANNEL_ADDR`
  service call.
