...
If the physical address is shared in the message data of any message type, it
must be a system-wide physical address.
...
microcontroller can only include the most recently occurred event of the same type.
