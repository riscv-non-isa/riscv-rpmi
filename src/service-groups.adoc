...
ifdef::rootpath[]
:imagesdir: {rootpath}{path}../images
endif::rootpath[]
...
include::partial$srvgrp-base.adoc[]

include::partial$srvgrp-system-msi.adoc[]

include::partial$srvgrp-system-reset.adoc[]

include::partial$srvgrp-system-suspend.adoc[]

include::partial$srvgrp-hart-state-management.adoc[]

include::partial$srvgrp-cppc.adoc[]

include::partial$srvgrp-voltage.adoc[]

include::partial$srvgrp-clock.adoc[]

include::partial$srvgrp-device-power.adoc[]

include::partial$srvgrp-performance.adoc[]

include::partial$srvgrp-management.adoc[]

include::partial$srvgrp-ras-agent.adoc[]

include::partial$srvgrp-request-forward.adoc[]
