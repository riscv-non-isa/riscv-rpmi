...
processors; therefore, each RPMI service group specifies the RISC-V privilege
levels of application processors that can access it. For example, the
...
for RPMI notification messages. An RPMI service group may implement its RPMI
