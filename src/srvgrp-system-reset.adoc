...
Supported events are described in <<system-reset-notifications>>.
...
*System Shutdown* and *System Cold Reset* are mandatory and supported by
default. *System Warm Reset* is defined by the RPMI specification and its
support can be discovered with this service.
...
| 0     | RESET_TYPE	| uint32	| Reset type
|===
