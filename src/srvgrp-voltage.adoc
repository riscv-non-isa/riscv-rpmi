...
!===
| 2	|NUM_LEVELS	 | uint32	| Number of voltage levels (in word)
supported by domain. Values are dependent on the VOLTAGE_FORMAT. Get the
voltage level format in VOLT_GET_SUPPORTED_LEVELS.
[cols="2,5a"]
!===
! *Value* 	!  *Description*
! 1		! When VOLTAGE_FORMAT=`0x0`
! 3		! When VOLTAGE_FORMAT=`0x1`
! 4N		! When VOLTAGE_FORMAT=`0x2` (Multiple of 4 voltage level word)
! N		! When VOLTAGE_FORMAT=`0x3` (Multiple of 1 depending number of
...
[cols="1,1,5"]
!===
3+! *Format: Fixed Voltage (VOLT_GET_ATTRIBUTES.FLAGS[31:30]: 0)*
...
[cols="1,1,5"]
!===
3+! *Format: Simple Linear (VOLT_GET_ATTRIBUTES.FLAGS[31:30]: 1)*
! *Word*	! *Name*	! *Description*
...
[cols="1,1,5"]
!===
3+! *Format: Multi-Linear (VOLT_GET_ATTRIBUTES.FLAGS[31:30]: 2)*
! *Word*	! *Name*	! *Description*
! 0		! min_uV	! Lower boundary of voltage level (uV)
...
[cols="1,1,5"]
!===
3+! *Format: Discrete (VOLT_GET_ATTRIBUTES.FLAGS[31:30]: `3`)*
! *Word*	! *Name*	! *Description*
! 0		! level_uV	! Discrete voltage level (uV)
! 1		! level_uV	! Discrete voltage level (uV)
3+! ...
! N		! level_uV	! Discrete voltage level (uV)
!===
